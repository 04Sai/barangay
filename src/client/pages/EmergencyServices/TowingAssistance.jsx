...
const TowingAssistance = () => {
  ...
  // Fetch user profile data and towing services on component mount
  useEffect(() => {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-3 md:col-span-2">
                ...
                <input
                  ...
                  placeholder="Enter vehicle details (make, model, plate number)"
                />
              </div>
            </div>
          </div>

          {/* Second Row - Available Towing Services */}
